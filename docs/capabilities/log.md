...
## 2026-09-20
* **Update**: Replace the working-but-unproven caveat with release-gated HTTP, golden, frame, and real WebSocket test evidence; retain browser/CORS and convention limits.
