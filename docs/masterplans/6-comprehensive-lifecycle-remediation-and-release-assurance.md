...
Existing EP-34, EP-35 and EP-46 are not children of this MasterPlan. EP-46 is docs/plans/46-unlink-the-nqe-supervisor-so-a-finished-app-cannot-kill-its-caller-during-gc.md, the urgent standalone fix for REV-16, which ships as its own patch release and is expected to complete before any child here starts. The exact paths and compatibility responsibilities of all three are recorded in EP-44; their completion must be checked rather than inferred from old status prose. At this revision master plan 5 lists EP-34 and EP-35 as Not Started, and EP-46 is drafted with its fix prototyped. Existing EP-36 concerns only the MessageDB adapter and is no longer a prerequisite of anything here.
...
- [ ] EP-39 M1: Add an executable metrics and endpoint test suite.
...
- [ ] EP-39 M4: Verify endpoint compatibility and accounting together.
